...
<body>
        ...
        if(isset($_POST['save']))
            {
                ...
                $insetQuery = "INSERT INTO `student_data` (`id`, `name`, `dept`, `cgpa`) VALUES ('$id', '$name', '$dept', '$cgpa')";
    ...
    <?php
        $query = "SELECT * FROM `student_data` ORDER BY cgpa ASC";
            ...
            if(isset($_POST["delete"]))
                {
                    $id = $_POST["delete"];
                    // delete($id);
                     $delQuery = "DELETE FROM `student_data` WHERE id = $id";
